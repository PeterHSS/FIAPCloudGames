...
public sealed class RemoveGameFromPromotionUseCase 
{
    private readonly IPromotionRepository _promotionRepository;
    private readonly IGameRepository _gameRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RemoveGameFromPromotionUseCase(IPromotionRepository promotionRepository, IGameRepository gameRepository, IUnitOfWork unitOfWork)
    {
    ...
    {
        Log.Information("Removing game with ID {GameId} from promotion with ID {PromotionId}.", gameId, promotionId);
        ...
        Log.Information("Game with ID {GameId} removed from promotion with ID {PromotionId}.", gameId, promotionId);
    }
}
