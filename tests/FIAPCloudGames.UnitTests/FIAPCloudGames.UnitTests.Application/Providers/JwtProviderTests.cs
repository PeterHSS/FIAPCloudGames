...
namespace FIAPCloudGames.Infrastructure.Tests.Providers
{
    public class JwtProviderTests
    {
        ...
        {
            Secret = "MinhaSuperSecretaChaveParaJWT1234567890!", // mínimo recomendado 16+ caracteres
        ...
        [Fact]
        public void Create_WithValidUser_ReturnsNonNullNonEmptyToken()
        {
            // Arrange
        ...
        [Fact]
        public void Create_TokenContainsExpectedClaims()
        {
            // Arrange
        ...
        [Fact]
        public void Create_TokenHasValidExpiration()
        {
            // Arrange
            User user = User.Create(
                name: "Teste",
            ...
            // Assert (permite +/- 1 minuto para o tempo de execução)
            Assert.InRange(token.ValidTo, DateTime.UtcNow, expectedExpiration.AddMinutes(1));
        }

        [Fact]
        public void Create_TokenIsValidWhenValidatedWithCorrectParameters()
        {
            // Arrange
